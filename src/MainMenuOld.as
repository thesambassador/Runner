package  
{
	 ...
	 * @author ...
	 */
	public class MainMenuOld extends FlxState
	{
		
		public var buttons : FlxGroup;
		
		public var startButton : FlxButton;
		public var highScoresButton : FlxButton;
		...
		override public function create():void
		{
			...
			highScoresButton = new FlxButton(middleScreen, 120, "HighScores", showHighscores);
			highScoresButton.x = centeredButton;
		...
		public function showHighscores() : void {
			...
			this.clear();
			var hsView : HighScoresView = new HighScoresView();
